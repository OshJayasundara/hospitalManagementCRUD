...
export default class PostDetails extends Component{
    ...
    componentDidMount(){
      ...
      render() {
        ...
        const { employeeId, firstName, middleName, lastName, mobileNumber, NIC, DOB, email } = this.state.doctor;
  
      return (
        <div className="container" >
            <h1 align="center"> Outpatient Doctor Profile</h1><br/>
                            ...
                            <div className="card-body">
                                <div className="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-secondary mb-1">{employeeId}</p>
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        <a className="btn btn-info" target="__blank" href={`/updateDoctor/${this.state.doctor._id}`}>Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
